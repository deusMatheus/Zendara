...
class db_manager:
    ...
    def reset_all(self):
        ...
        self.create_table('character_sheets','(character_name, character_species, character_job, character_level, max_hp, current_hp, strength_score, agility_score, logic_score, spirituality_score, movement_speed, equipment_list, weapons, armor, condition)')
